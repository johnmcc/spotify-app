...
var About = function About() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        "a",
        { id: "github", href: "https://github.com/johnmcc/spotify-app" },
...
var _MainRouter = __webpack_require__(34);
...
var _Spotimy = __webpack_require__(63);

var _Spotimy2 = _interopRequireDefault(_Spotimy);
...
var _InfoBox = __webpack_require__(36);

var _InfoBox2 = _interopRequireDefault(_InfoBox);

var _SongList = __webpack_require__(60);
...
var _BeginBtn = __webpack_require__(62);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    key: 'setSelectedSong',
    value: function setSelectedSong(song, songInfo) {
    ...
    value: function render() {
      if (this.props.spotimy.accessToken) {
        ...
        var Elements = _react2.default.createElement(_BeginBtn2.default, { location: this.props.spotimy.getAuthURL() });
      }
...
var _reactGoogleCharts = __webpack_require__(37);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var InfoBox = function InfoBox(_ref) {
  var selectedSong = _ref.selectedSong,
      selectedSongInfo = _ref.selectedSongInfo;

  if (!selectedSong) return null;

  var getArtists = function getArtists() {
    return selectedSong.artists.map(function (artist) {
      return artist.name;
    }).join(" / ");
  };
  ...
  var getData = function getData() {
    ...
    return [['Danceability', 'Happiness', 'Energy'], [danceability, valence, energy]];
  };
...
var _DEFAULT_CHART_COLORS = __webpack_require__(57);

var _DEFAULT_CHART_COLORS2 = _interopRequireDefault(_DEFAULT_CHART_COLORS);

var _GoogleChartLoader = __webpack_require__(58);
...
var script = typeof window !== 'undefined' ? __webpack_require__(59) : function (link, _ref) {
...
var _Song = __webpack_require__(61);
...
var SongList = function (_React$Component) {
  ...
  _createClass(SongList, [{
    ...
    value: function componentDidMount() {
      ...
      fetch(this.props.spotimy.getRecentlyPlayedUrl(), options).then(function (response) {
        response.json().then(function (data) {
          _this2.setState({ songs: data.items });
          return data.items.map(function (item) {
            return item.track.id;
          }).join(",");
        }).then(function (ids) {
          fetch(_this2.props.spotimy.getSongInfoUrl(ids), options).then(function (response) {
            response.json().then(function (data) {
              _this2.setState({ audio_features: data.audio_features });
            });
          });
        });
      });
    ...
    value: function render() {
      ...
      try {
        for (var _iterator = this.state.songs.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var _step$value = _slicedToArray(_step.value, 2),
              index = _step$value[0],
              song = _step$value[1];

          rows.push(_react2.default.createElement(_Song2.default, {
            key: index,
            spotimy: this.props.spotimy,
...
var Song = function Song(_ref) {
  var track = _ref.track,
      audio_features = _ref.audio_features,
  ...
  return _react2.default.createElement(
    "div",
    { className: "played", onClick: handleClick },
    _react2.default.createElement(
      "p",
      { className: "song" },
      track.name
...
var BeginBtn = function BeginBtn(_ref) {
...
var Spotimy = function () {
  ...
  _createClass(Spotimy, [{
    ...
    key: "getRecentlyPlayedUrl",
    value: function getRecentlyPlayedUrl() {
      return "https://api.spotify.com/v1/me/player/recently-played";
    }
  }, {
    key: "getSongInfoUrl",
    value: function getSongInfoUrl(ids) {
...
"use strict";
throw new Error("Cannot find module \"react\"");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_hoist_non_react_statics__ = __webpack_require__(79);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_history_createHashHistory__ = __webpack_require__(81);
